...
const LandingPage = () => {
  return (
    <div>
      <main className="min-h-screen pt-[120px] flex flex-col justify-center text-white overflow-hidden relative px-6 md:px-12 lg:px-[70px]">
        <section className="flex flex-col items-center justify-center gap-10 md:gap-16 lg:gap-20 lg:flex-row lg:justify-between">
          ...
          <div className="hidden sm:flex flex-col items-center w-full lg:w-auto">
            ...
            <div className="absolute   top-[70%] right-[50%] lg:top-96 lg:right-60 animate-infinite-translate">
              <img src={client} alt="" className="w-56 lg:w-auto" />
            </div>

            <div className='animate-infinite-translateY w-20 md:w-40 lg:w-[250px] absolute  bottom-0 lg:right-0'>
